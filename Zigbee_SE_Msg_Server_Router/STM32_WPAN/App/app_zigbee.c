...
static enum ZclStatusCodeT messaging_client_get_last_msg_cb(struct ZbZclClusterT *clusterPtr, void *arg, struct ZbZclAddrInfoT *srcInfo);
static enum ZclStatusCodeT messaging_client_msg_cnf_cb(struct ZbZclClusterT *clusterPtr, void *arg, struct ZbZclMsgMessageConfT *conf, struct ZbZclAddrInfoT *srcInfo);
...
static void APP_ZIGBEE_InitCallback(struct ZbZclMsgServerCallbacksT *ClusterServerCallback)
{
  ...
  ClusterServerCallback->get_last_message=messaging_client_get_last_msg_cb;
  ClusterServerCallback->message_confirmation=messaging_client_msg_cnf_cb;
  ClusterServerCallback->get_message_cancellation=messaging_client_msg_cancel_cb;
...
static void APP_ZIGBEE_InitMsg(void)
{
        ...
        strcpy(my_second_message.message_str,"Good Bye");
...
//  req.deviceId = ZCL_DEVICE_xxxx;
  ...
  /* Messaging Server */
  /* Server callback can not be null */
  zigbee_app_info.messaging_server_1 = ZbZclMsgServerAlloc(zigbee_app_info.zb, SW1_ENDPOINT, &my_msg_client_cmd_cb, NULL);
